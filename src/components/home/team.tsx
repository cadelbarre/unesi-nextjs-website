  ...
  return (
    <Container className='py-16 md:py-24 grid place-items-center'>
      <header className='mb-6 text-center flex flex-col justify-center items-center max-w-[42rem] mx-auto'>
        <h2 className='text-5xl font-bold pb-4 text-primary'>Nuestros Medicos</h2>
      ...
      <section className='mt-10 md:mt-20'>
        <ul className='grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16'>
          <li className='flex flex-col md:flex-row gap-6 border tranlate-y-0 border-gray-50 hover:cursor hover:shadow-lg hover:-translate-y-2 transition duration-500 ease-in-out p-0 md:p-5 rounded-lg '>
            <img
              ...
              alt=''
              className='rounded-lg w-full md:w-52 aspect-[4/5] object-cover'
              loading='lazy'
            />
