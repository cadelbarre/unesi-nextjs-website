    ...
    <div className='md:col-span-3 lg:col-span-2 '>
      <div className='grid grid.cols-1 md:grid-cols-2 gap-16 md:gap-8 '>
        ...
        <div className='text-sm md:ml-6'>
          ...
          <ul className='flex flex-col gap-y-2 mt-6 text-gray-200 space-y-3'>
        ...
        <div className='text-sm md:-ml-6'>
          ...
          <ul className='flex flex-col gap-y-2 mt-6 text-gray-200 space-y-3'>
            <li className='flex gap-x-3 leading-6'>
              ...
              <span className='w-full h-full text-balance'>
                {unesi.ubicacion.direccion + ' ' + unesi.ubicacion.ciudad}
              </span>
            </li>
            <li className='flex gap-x-3 leading-6'>
