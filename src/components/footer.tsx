      ...
      <Container className='flex flex-col gap-12 lg:gap-20 '>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='space-y-6 md:col-span-1 lg:col-span-2'>
            <img
              src='/logos/unesi-logo-bw.png'
              alt='logo unesi monocrómatico'
              className='aspect-auto h-20 object-contain'
              loading='lazy'
            />
            <p className='text-sm text-gray-100 leading-6 max-w-[55ch]'>Somos una organización conformada por un grupo de profesionales de la salud certificados a nivel nacional e internacional en el área de neurocirugía y neurocirugía intervencionista</p>
            <div className='text-gray-100 flex'>
              <a href='https://www.instagram.com/unesi.sas/' target='_blank' className='transition duration-500 ease-in-out scale-100 hover:scale-110 hover:text-white' rel='noreferrer'>
