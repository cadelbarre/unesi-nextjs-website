...
export default function Button ({ className, children, ...attr }: Props): JSX.Element {
  return (
    <button className={twMerge('group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-neutral-950 px-6 font-medium text-neutral-200', className)} {...attr}>
      <span>{children}</span>
