                ...
                info.politicas.map(politica => {
                  return (
                    <div className='relative' key={politica.title}>
                      ...
                      <dd className='mt-2 text-base leading-[1.7] text-gray-800 text-balance'>{politica.description}</dd>
                    </div>
                  )
                })
              }
