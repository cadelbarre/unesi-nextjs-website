        ...
        <div className='mx-auto max-w-7xl lg:px-8'>
          ...
          <div className='mx-auto mt-10 sm:mt-16 max-w-2xl lg:max-w-4xl'>
            ...
            <div className='w-full md:w-4/5 flex flex-col gap-y-14 sm:gap-y-20 '>
              <div>
                <h2 className='pb-8 text-3xl tracking-tight font-bold text-primary-black text-balance'>Mis Derechos</h2>
              ...
              <div>
                <h2 className='pb-8 text-3xl tracking-tight font-bold text-primary-black text-balance'>Mis Deberes</h2>
                <div className='ml-4 space-y-8'>
                  <article>
